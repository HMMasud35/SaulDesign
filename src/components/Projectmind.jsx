...
const Projectmind = () => {
  return (
    <section className='py-[258px] border-b-1 border-font_primary/10'>
      <img className='absolute -z-10 mt-[-182px] ml-[270px]' src={Projectshape} alt="" />
      <div className='container flex'>
        ...
        <div className='w-1/2 h-[508px]'>
          ...
          <input className='project_input mt-[10px]' placeholder='Name' type="text" />
