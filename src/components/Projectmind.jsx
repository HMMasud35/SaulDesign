...
const Projectmind = () => {
  return (
    <section className='py-15 lg:py-64.5 border-font_primary/10'>
      <img className='absolute mt-[-25px] lg:mt-[-182px] xl:ml-[190px] xl:mt-[-182px] lg:ml-0 -z-1' src={Projectshape} alt="" />
